...
// const redirect_uri = 'https://food-meets-tinder.herokuapp.com/auth/callback'

// redirect to oauth provider
router.get('/login', (req, res, next) => {
  const url = 'https://www.facebook.com/v2.8/dialog/oauth';
  const queryParams = `client_id=${client_id}&redirect_uri=${redirect_uri}` //&scope=user_birthday,user_likes,user_photos,user_posts,user_location
